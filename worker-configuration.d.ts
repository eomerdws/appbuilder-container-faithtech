/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 07e0d7a8548211f842ab6ada4f451a90)
// Runtime types generated with workerd@1.20260708.1 2026-07-11 nodejs_compat
interface __BaseEnv_Env {
	DB?: D1Database;
	ASSETS: Fetcher;
	ENVIRONMENT: "staging" | "production" | "local";
	ALLOWED_ORIGIN: "https://replace-with-staging-web-origin.example" | "https://replace-with-production-web-origin.example" | "http://localhost:5173";
...
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		ASSETS: Fetcher;
		ENVIRONMENT: "staging";
		ALLOWED_ORIGIN: "https://replace-with-staging-web-origin.example";
		SESSION_SECRET: string;
		SCRIPTORIA_API_KEY: string;
	}
	interface ProductionEnv {
		...
		ALLOWED_ORIGIN: "https://replace-with-production-web-origin.example";
		SESSION_SECRET: string;
		SCRIPTORIA_API_KEY: string;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "ALLOWED_ORIGIN" | "SESSION_SECRET" | "SCRIPTORIA_API_KEY">> {}
}
