...
declare module '$env/static/private' {
	...
	export const PHOTOQT_MAGICK_CODER_MODULE_PATH: string;
	export const PHOTOQT_MAGICK_FILTER_MODULE_PATH: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		PATH: string;
		PATHEXT: string;
		PHOTOQT_MAGICK_CODER_MODULE_PATH: string;
		PHOTOQT_MAGICK_FILTER_MODULE_PATH: string;
